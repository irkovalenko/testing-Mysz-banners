(function () {
  ...
  var Ga = "lastPosition",
    ...
    id = " translateZ(",
    jd =
      '" gradientUnits="userSpaceOnUse" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="">',
    kd =
      '" patternUnits="objectBoundingBox" width="1" height="1" viewBox="0 0 1 1" preserveAspectRatio="xMidYMid slice">',
    ...
    Td =
      "'classid='clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B'codebase='http://apple.com/qtactivex/qtplugin.cab'width='",
    Ud = "'controller='",
    Vd =
      "'enablejavascript='true'postdomevents='true'scale='tofit'name='embedobj_",
    Wd = "'height='",
    Xd = "'id='embedobj_",
    Yd = "'loop='",
    Zd = "'volume='",
    ...
    lg = "<image ",
    mg = '<linearGradient id="',
    ng = '<path id="',
    og = '<pattern id="',
    pg = '<stop offset="0%" stop-color="" stop-opacity="1"></stop>',
    qg = '<stop offset="100%" stop-color="" stop-opacity="1"></stop>',
    rg = '<style id="" type="text/css">',
    sg =
      '<svg width="100%" height="100%" style="position:absolute;" preserveAspectRatio="none" version="1.1" xmlns="http://www.w3.org/2000/svg">',
    tg = "=",
    ug = "?",
    vg = "@1x",
    wg = "@2x",
    ...
    qn = "href",
    rn =
      'href="" x="0" y="0" width="1" height="1" preserveAspectRatio="xMidYMid slice" />',
    sn = "http://",
    tn = "hue-rotate(",
    un = "hype-obj-",
    vn = "hype-scene-",
  ...
  (function () {
    v.HYPE_778F = function (
        ...
        if (!(fa != h || a == k || 0 < Ib || f == k || f.ob == h)) {
          ...
          if (!(0 == l && m == k)) {
            ...
            (m == k && 0 != l) == h
              ? ((m = vj(a)),
                (m = wj(a, m, h)),
                m == k && (m = B.Body[Ha]({ elementId: a.id })),
                (m.plugin = n(a, Om, {})),
                B.Composite.add(g, m),
                (f.Qa[j] = m))
              : q == h &&
                (B.Composite.remove(g, m),
                V(a, Om, m.plugin),
                delete f.Qa[j],
                (m = k));
            f = n(a, ql, 0.5);
            ...
            if (m != k) {
              ...
              if (
                ...
                (m.isStatic != l && B.Body.setStatic(m, l),
                  ...
                  B.Body.setAngle(m, e),
                  m.Ga == k
                    ? (B.Body.setVelocity(m, { x: c - t, y: d - u }),
                      B.Body.setAngularVelocity(m, e - s))
                    : (B.Body.setVelocity(m, { x: 0, y: 0 }),
                      B.Body.setAngularVelocity(m, 0)),
                  (m.restitution = f),
                  (m.friction = g),
                  (m.frictionAir = j),
                  B.Sleeping.set(m, p),
      ...
      function Ic(a) {
        ...
        if (!(fa != h || a == k || b == k || b.ob == h)) {
          ...
          if (!(0 == n(a, il, 0) || c == k)) {
            Ib += 1;
            for (
              var d = [], e = b.oa.pairs.list, f = b.oa.pairs.table, g = 0;
              g < e[X];
              g++
            )
            ...
            for (g = 0; g < d[X]; g++)
              ((j = d[g] - g), delete f[e[j].id], e[bb](j, 1));
            d = vj(a);
      ...
      function wj(a, b, c) {
        ...
        if (f == k || 2 > f[X])
          return (
            v.HYPE_DEBUG_PHYSICS == h && console.log(Vm + a.id + $c + b),
            k
          );
        ...
        B.HypePlugin && B.HypePlugin.fromVerticesWithFallback
          ? ((g = B.HypePlugin.fromVerticesWithFallback(
              g.x,
              g.y,
              f,
              { elementId: a.id },
        ...
        if (m == k)
          return (v.HYPE_DEBUG_PHYSICS == h && console.log(Wm + a.id), k);
        m.render.path = b;
        b = hf(a);
        b = zj(b);
        b = qd(b, [g.x, g.y]);
      ...
      function vj(a) {
        ...
        if (e != k) {
              ...
              for (f = 0; f < e[X]; f++)
                if (((j = e[f]), 0 == f)) {
                  ...
                  var t = e[f + 1],
                    ...
                    t = t + r.PI / 2;
                  if (y > g && 0 > u)
                    (m[z](E(j.x - r.cos(s) * q, j.y - r.sin(s) * q)),
                      m[z](E(j.x - r.cos(t) * q, j.y - r.sin(t) * q)));
                  else m[z](E(j.x + C, j.y + x));
                  if (y > g && 0 <= u)
                    (l[z](E(j.x + r.cos(s) * q, j.y + r.sin(s) * q)),
                      l[z](E(j.x + r.cos(t) * q, j.y + r.sin(t) * q)));
          ...
          if (0 < m || 0 < s) {
            y = kf(m, s);
            for (C = 270 + y; 360 > C; C += y)
              ((e = m * B.Common.cos((C * r.PI) / 180) + (d - m)),
                (f = s * B.Common.sin((C * r.PI) / 180) + s),
                b[z](E(e, f)));
          }
          b[z](E(d, s));
          b[z](E(d, c - u));
          if (0 < t || 0 < u) {
            y = kf(t, u);
            for (C = 0 + y; 90 > C; C += y)
              ((e = t * B.Common.cos((C * r.PI) / 180) + (d - t)),
                (f = u * B.Common.sin((C * r.PI) / 180) + (c - u)),
                b[z](E(e, f)));
          }
          b[z](E(d - t, c));
          b[z](E(j, c));
          if (0 < j || 0 < q) {
            y = kf(j, q);
            for (C = 90 + y; 180 > C; C += y)
              ((e = j * B.Common.cos((C * r.PI) / 180) + j),
                (f = q * B.Common.sin((C * r.PI) / 180) + (c - q)),
                b[z](E(e, f)));
          }
          b[z](E(0, c - q));
          b[z](E(0, l));
          if (0 < g || 0 < l) {
            y = kf(g, l);
            for (C = 180 + y; 270 > C; C += y)
              ((e = g * B.Common.cos((C * r.PI) / 180) + g),
                (f = l * B.Common.sin((C * r.PI) / 180) + l),
                b[z](E(e, f)));
          }
        }
        d = hf(a);
        ...
        for (j = 0; j < b[X]; j++)
          ((g = qd(d, [b[j].x, b[j].y])),
            (c = r[Gb](g[0])),
            (g = r[Gb](g[1])),
            (0 == a[X] || a[a[X] - 1].x != c || a[a[X] - 1].y != g) &&
              a[z]({ x: c, y: g }));
        b = Z;
        for (d = 0; d < a[X]; d++)
          (1 < a[X] && d == a[X] - 1 && a[d].x == a[0].x && a[d].y == a[0].y) ||
            (b += wi + a[d].x + $ + a[d].y + $);
        return b;
      }
      function Ig(a) {
      ...
      function Ej(a, b) {
        ...
        for (g = 0; a.Va >= f && 20 > g; )
          (B.Engine.update(a.oa, f), (a.Va -= f), (g += 1));
        lf = a.ob = h;
        ...
        for (g = 0; g < f[X]; g++)
          if (
            ((e = f[g]),
            (j = w[Vb](e.elementId)),
            !(e.elementId == k || e.isStatic == h || Ig(j) == h))
          ) {
            xj(j);
      ...
      function Gj(a, b) {
        if (!(b.gamma == k || b.beta == k)) {
          ...
          mf(d) == h &&
            ((c = nf(d) * a.Qb),
            (d = of(d) + a.Pb),
            (a.oa.world.gravity.x = c * B.Common.cos((d * r.PI) / 180)),
            (a.oa.world.gravity.y = c * B.Common.sin((d * r.PI) / 180)));
          le(a);
          rd();
        }
      }
      ...
      function mf(a) {
        ...
        if (Ng(a) == h) return ((a = pf(w[Vb](a))), a == k ? mf(k) : mf(a.id));
        a = M[a];
        var b = Wa(ka(a));
        return A[b].v[a].cA;
      }
      function of(a) {
        ...
        if (Ng(a) == h) return ((a = pf(w[Vb](a))), a == k ? of(k) : of(a.id));
        a = M[a];
        var b = Wa(ka(a));
      ...
      function nf(a) {
        ...
        if (Ng(a) == h) return ((a = pf(w[Vb](a))), a == k ? nf(k) : nf(a.id));
        a = M[a];
        var b = Wa(ka(a));
        return A[b].v[a].bY;
      }
      ...
      function ud(a) {
        ...
        if (c != Z && f != Z) {
          ...
          for (j = 0; j < d[X]; j++)
            d[j][kb](ro) == Rf
              ? (d[j][Y](jp, c), d[j][Y](kp, a))
              : d[j][kb](ro) == Yf && (d[j][Y](jp, f), d[j][Y](kp, g));
        } else if (g != k) {
          c = a.id + Ti;
          e = Qp + c + ae;
          c = w[Vb](c);
      ...
      function Hj(a) {
        ...
        b == k ||
          c == k ||
          ((a = a[hb](up)), 0 != a[X] && a[0][Y](Zp, df + b + $ + c));
      }
      function Jb(a) {
        var b = a.id + Ui;
        ...
        if (b && c) {
          ...
          if (1 == e) {
            ...
            0 != q &&
              ...
              ((l = l.vb()),
              (q = E(g[G] / m[G], g[L] / m[L])),
              (t = E(g.x - m.x * q.x, g.y - m.y * q.y)),
              l.$b(q),
              l.zb(t),
              j[z](l));
            m = [];
            for (l = 0; l < j[X]; l++)
              ((q = j[l]), m[z](q), (q = q.vb()), q.reverse(), m[z](q));
            j = m;
            if (f == h) {
              f = [];
              for (m = 0; m < j[X]; m++) {
            ...
            for (m = 0; m < j[X]; m++) {
              ...
              D = C - 1;
              for (N = T - 1; 0 < D || 0 < N; )
                0 < D && 0 < N && O[D][N] == O[D - 1][N - 1] + Lj(x[D], y[N], s)
                  ? (q[vb](x[D--]), t[vb](y[N--]))
                  : 0 < D && O[D][N] == O[D - 1][N] + 0
                    ? (q[vb](x[D--]), t[vb](Mj()))
                    : (q[vb](Mj()), t[vb](y[N--]));
      ...
      function Qg(a) {
        return { aa: Pa(a.aa), ha: Pa(a.ha), la: Pa(a.la), nb: a.nb };
      }
      function Kb(a, b, c) {
        return { aa: Pa(a), ha: Pa(b), la: Pa(c), nb: p };
      }
      function Mj() {
        var a = E(0, 0);
        return { aa: Pa(a), ha: Pa(a), la: Pa(a), nb: h };
      }
      function Dj(a) {
      ...
      function Jj(a) {
        ...
        if (b && 0 < b[X]) {
          ...
          var d = [];
          if (0 == c[X])
            (Xa(d, 0, b), Xa(d, 2, b), Xa(d, 4, b), Xa(d, 6, b), c[z](d));
      ...
      function Ij(a) {
        var b = [],
          c = a[ic];
        if (c) for (var d = 0; d < c[X]; d++) b[z](c[d][nb](0));
        ...
        return function (c) {
          for (var d = 0; d < b[X]; d++) {
            ...
            if (1 == f) vd(Sj(e.e, e.f), e.g, e.d);
              ...
              e.b != k &&
                ((f = e.z != ba ? e.z : p), Lb(e.b, a != k ? a.id : k, f));
            else if (7 == f) e.b != k && Mb(e.b, e.r);
            else if (8 == f)
              e.b != k &&
                ((f = e.z != ba ? e.z : p), wd(e.b, f, h, e.J != ba ? e.J : p));
              ...
              ((f = e.o), (e = e.q), e != h && (e = p), f != k && qq(f, e));
      ...
      function Wj(a) {
        ...
        F.dc == k &&
          (1 == 1 - c && a[H].removeProperty != k
            ? a[H].removeProperty(ca.wa + Cl)
            : (a[H][ca.wa + Cl] = xl + K(b) + Vc + (1 - c) + De));
      }
      function Wg(a) {
        var b = n(a, Mi);
        if (b != k) {
        ...
        if (!(12 > F.$)) {
          ...
          b == h
            ? ((a[H][ca.wa + tl] = c),
              ...
              (c = a[H][lb]),
              qa(a[H], no),
              qa(a[H], a[H][lb] + (Z + a[Hb]).substring(0, 0)),
              qa(a[H], c))
            : ((a[H][ca.wa + dn] = c), (a[H].filter = c));
        }
      }
      function xd(a) {
        Xg(a, p);
      ...
      function re(a) {
        if (1 == n(a, kn, 0)) Xg(a);
          ...
          if (!(b == k || c == k || d == k || e == k))
            for (
              var g = [ca.wa + Dl, Ai, El, Dl],
                j = 0 == b && 0 == c && 0 == e,
                b = (2 == f ? Gn : Z) + K(b) + $ + K(c) + $ + K(e) + $ + eb(d),
                c = 0;
              c < g[X];
              c++
            )
        ...
        if (u == h)
          var c = n(a, wp, 0.5) * x,
            ...
            t =
              t +
              ($ +
                (ca.pb + Ze + b[0] + fe + b[2] + ge + b[1] + he + b[3] + ie));
        l != k && (t += $ + l);
        q != k && (t += $ + q);
        a[H].filter = t;
        if (u == h) {
      ...
      function Zg(a) {
        function b(a, b) {
          var j =
            b == h ? (r.abs(e) + 180) % 360 : (360 - r.abs(e) + 270) % 360;
      ...
      function ak(a) {
        return (
          typeof a == lp &&
          (((7 == a[X] || 4 == a[X]) && a[Hc](0) == md) ||
            (0 == a[$b](Uo) && a[$b](ae) == a[X] - 1))
        );
      }
      function bk(a, b, c) {
        var d = c.da,
        ...
        else if (typeof Ad[t] === gn)
          ((s = Ca(c)),
            (u = d == h ? s - e - f : e),
            (s = Ad[t](d == h ? s - b - u : b - e, u, f)));
        else
          a: {
        ...
        if (pd[t] && 2 == pd[t].p) u = s;
              ...
              for (f = x = C = 0; f < q.va[X]; f++) {
                ...
                if (0 == f)
                  var C = ob(d),
                    ...
                    x = T + x / 2 - y.sa.y;
                t[z]({
                  sa: { x: y.sa.x + C, y: y.sa.y + x },
                  La: { x: y.La.x + C, y: y.La.y + x },
                  Ha: { x: y.Ha.x, y: y.Ha.y },
                  Ia: { x: y.Ia.x, y: y.Ia.y },
                  length: 0,
                  ea: [],
                });
                x = C = 0;
          ...
          c = ck(d, s, j);
          g == Vi
            ? ((u = c.x), n(m, ll) == Pi && W(m, kl, c.Ra))
            : g == Yk && (u = c.y);
        } else if ((d == h && (s = 1 - s), typeof l == po || typeof q == po))
          ((c = bh(l)), (j = bh(q)), (u = c + (j - c) * s));
          ...
          if (
            ...
            for (a = 0; a < D[X]; a++) {
              e = [];
              for (d = 0; 8 > d; d++)
                ((l = D[a][d]), e[z](l + (s[a][d] - l) * c));
              u[z](e);
            }
            u = { path: u, closed: j[Qa] };
          }
      ...
      function ck(a, b, c) {
        ...
        if (0 > b || 1 < b) {
          ...
          if (f != k && e != k) {
            ...
            0 == b
              ? ((g.y = 0), (g.x = d))
              : ((g.y = r[Ua](r.pow(d, 2) / (r.pow(a, 2) / r.pow(b, 2) + 1))),
                (g.x = (g.y * a) / b));
          ...
          if (1 == b) ((d = a.va), (f = d[d[X] - 1]), (g = 1));
            ...
            g =
              (g +
                (d - a) /
                  (g + 1 < f.ea[X] ? f.ea[g + 1] : f.ea[f.ea[X] - 1])[X]) /
              (f.ea[X] - 1);
          }
          g = fk(f, g);
        }
        ...
        if (0 == j[X] || d == p) ch(m, b, g);
          ...
          for (var q = (d = 0), n = b.fa, s = b.da, l = 0; l < j[X]; l++) {
            ...
            if (!(c == p && t != m)) {
              ...
              if (f != b.ia || b.ia == k || n != b.fa || C || s != b.da)
                ((e = h), (d = t));
            }
          }
          e == p && ch(m, b, g);
            ...
            if (e.fa != p) {
              ...
              if (f * e.ja <= j) {
                if (0 < e.qa[X]) a = 0;
                  ...
                  e.Ca < g[X] &&
                  ((g = Da((Ob(g[e.Ca], e) - f * e.ja) / e.ja, e)),
                  a == k || g < a)
                )
                  a = g;
                g = e.da == p ? e.fb : e.sb;
        ...
        if (fa == h)
          for (d = 0; d < Ea[X]; d++)
            if (((j = Ea[d]), (e = la(j.ca)), e != k && e.fa == h)) {
              e.ac != k && (e.ia += c - e.ac);
              for (
                var f = r.max(0, c - e.ia),
                  g = j,
                  m = B.Composite.allBodies(g.oa.world),
                  l = p,
                  q = 0;
                q < m[X];
                q++
                ...
                if (-1 == x) {
                  2 == s && Ig(u) == p && t.Ga != k
                    ? ((t = u),
                      ...
                      (s = x.oa.world),
                      (t = x.Qa[M[t.id]]),
                      t.Ga != k && (B.World.remove(s, t.Ga), delete t.Ga),
                      mc(u, h))
                    : 1 == s &&
                      Ig(u) == p &&
                      (B.Body.setVelocity(t, { x: 0, y: 0 }),
                      B.Body.setAngularVelocity(t, 0));
                  for (t = 0; t < td[X]; t++)
                    (V(u, Z + td[t] + Jl, k), V(u, Z + td[t] + Il, k));
                } else {
                  g.jb[bb](x, 1);
                  for (t = 0; t < td[X]; t++) {
                    var x = td[t],
                    ...
                    4 <= C[X] &&
                      ...
                      (C = C[C[X] - 2]),
                      (y =
                        ((C.value - l.value) / (C.time - l.time)) * (1 / 60)),
                      (l = h));
                    V(u, Z + x + Jl, y);
                  }
                  2 == s &&
                    ...
                    t.Ga == k &&
                      ((x = B.Constraint[Ha]({
                        ...
                        stiffness: 1,
                        angularStiffness: 1,
                        render: { strokeStyle: od, lineWidth: 3 },
                      })),
                      B.World.add(s, x),
                      (t.Ga = x)));
      ...
      function hk(a, b) {
        ...
        if (c != k)
          for (var e = 0; e < c[X]; e++) {
            ...
            g == k ||
              -1 != Ia(d, f) ||
              (Dd(g), b == h && dh(g, h), Xb(0, f, p, h), d[z](f));
          }
      }
      function Xb(a, b, c, d) {
        Af(b);
      ...
      function Mb(a, b, c) {
        ...
        a != k &&
          a.fa == h &&
          (ue(a, 1),
          (a.na = b != k ? b : Bb(ba) / 1e3 - a.ia),
          (a.fa = p),
          v[Sa](a.Da),
          c == h && a.pa != k && a.na == a.pa.d && Ed(a));
      }
      function Ed(a) {
        if (!(fa == h && a.Ja == h) && ((a.ja = 1), !Mc(Ca(a), a, h, h)))
          if (a.pa.q == h) Lb(a.ca, k, a.da);
          else if ((Dd(a), ve != k && Bf == a.ca))
            ((a = ve), (Bf = ve = k), a());
      ...
      function jk(a) {
        for (var b = 0; b < Pb[X]; b++) {
          var c = Pb[b];
          if (!(a != k && c.ca == a.ca))
            for (var d = 0; d < c.qa[X]; d++)
              sb[c.qa[d].o][c.qa[d].i] != c.ca && (c.qa[bb](d, 1), d--);
        }
      }
      function eh(a, b) {
        for (var c = a.ra, d = 0; d < c[X]; d++) {
          var e = c[d],
            ...
            e = Da(Ob(e, a) + e.d, a);
          sb[f] === ba && (sb[f] = {});
          if (e >= b && (cb[f] === ba || cb[f][g] === ba || cb[f][g] == a.ca))
            sb[f][g] = a.ca;
        }
        jk(a);
      }
      function Lb(a, b, c) {
        ...
        if (f != k)
          if (
            ((f.sc = b), Pb[z](f), A[U].T[f.ca] == k && f.Ab == ba && f.Ja != h)
          )
            Ed(f);
          else if (
            ((a = c == p),
      ...
      function dh(a, b) {
        for (var c = 0; c < a.ra[X]; c++) {
          var d = a.ra[c],
            ...
            g = d.r;
          try {
            if (g == h && aa[e][f] != k && (b || d.b == k))
              ((d.b = aa[e][f]), f == jm && Pg(d));
          } catch (j) {}
        }
      }
      function la(a) {
        for (var b = 0; b < tb[X]; b++) {
          var c = tb[b];
          if (c.ca == a) return c;
        }
        for (var d in ha)
      ...
      function we(a, b, c, d) {
        ...
        for (c = 0; c < tb[X]; c++)
          tb[c].ca == a && (Dd(tb[c]), tb[bb](c, 1), (c -= 1));
        tb[z](b);
        return b;
      }
      function Cd(a, b) {
      ...
      function Ug(a, b, c) {
        ...
        if (b != k) {
          ...
          a = a ? a : v[Qb];
          if (a[La] == $n || a[La] == Jo || a[La] == yi)
            ((b = A[U].v[c].aM), b != k && Vj(a, b, c));
        }
      }
      function Vj(a, b, c) {
        var d = A[U].T[b];
      ...
      function dk(a, b) {
        if (1 == a[3] || b == h) {
          for (var c = ca.xb, d = md, e = 0; 3 > e; e++)
            d += c[Hc](a[e] / 16) + c[Hc](a[e] % 16);
          return d;
        }
        return (
          Wo + ea(a[0]) + de + ea(a[1]) + de + ea(a[2]) + de + da(a[3]) + ae
        );
      }
      function K(a, b) {
      ...
      function oe(a) {
        ...
        if (0 == a[$b](Uo)) {
          ...
          a[Hc](0) == md && (a = a[nb](1));
          a = a.toUpperCase();
          for (var d = 3 == a[X] ? 0 : 1, e = ca.xb, c = 0; 3 > c; c++)
            b[c] =
              16 * e[$b](a[Hc](c * (1 + d))) + e[$b](a[Hc](c * (1 + d) + d));
        }
        return b;
      }
      function bh(a) {
      ...
      function hh(a, b, c, d) {
        ...
        c = A[U].a;
        c != k
          ? (pa(b[H], Yf), pa(S[H], c + Ld))
          : (pa(b[H], K(A[U].Y)), pa(S[H], b[H][G]));
        c = A[U].b;
        c != k
          ? (ua(b[H], Yf), ua(S[H], c + Ld))
          : (ua(b[H], K(A[U].Z)), ua(S[H], b[H][L]));
        Kc[S.id] = k;
        Kc[b.id] = k;
        for (c = 0; c < A[X]; c++) {
          var e = ka(A[c].o);
        ...
        aa[M[a.id]] &&
          ...
          a != b &&
          (a[Y](Rk, h),
          W(a, ml, 0, mj, 0, Yk, 0, Vi, 0, iq, 0, Nm, 1),
          V(a, $h, cf));
        S[H][Se] = k;
        S[H][ca.wa + Lp] = en;
        S[H][Ke] = k;
        ...
        for (f in ha)
          if (ha[I](f) != p) {
            ...
            g == p &&
              ((c = ha[f][Bc]), c[dc][vc] == Kh && (c = c[dc]), j[Fb](c));
          }
        S[Eb](Rk);
        S[Eb](Qk);
        b[Eb](Rk);
        if (d == h) {
          ...
          if (fa == h) {
            rc();
            for (c = 0; c < Ea[X]; c++)
              ((d = Ea[c]), la(d.ca).fa != h && Lb(d.ca, k, p));
          }
          d = Fd(va());
          for (c = 0; c < d[X]; c++)
            if (((g = d[c]), sd(g) != p)) {
          ...
          c = { type: mi };
          Ab(c, va()) !== p &&
            ((d = A[Cf(M[b.id])].A), d != k && ((d = d.a), ia(va(), d)(c)));
          c = Wa(b);
          b = ih(b);
          for (d = 0; d < b[X]; d++)
            if (((f = b[d]), (a = w[Vb](f)), (f = A[c].v[M[f]]), f != k))
              for (e = 0; e < Ff[X]; e++)
                ((j = Ff[e]), f[I](j) != p && W(a, j, f[j]));
        }
      }
      function pk(a, b, c, d) {
        var e = ha[b][Bc];
          ...
          for (c = 0; c < Ea[X]; c++)
            ((d = Ea[c]),
              d.ca == k &&
                ...
                (d = k),
                Mg(e) == h && (d = M[e[wc]]),
                (e = { Ja: h, ra: [], ca: f, qc: e, Ab: d }),
                d != k ? ha[d].Hb[z](e) : tb[z](e)));
          c = function () {
            for (var b = a[vc] == Mh, c = ih(a), d = 0; d < c[X]; d++) {
              var e = w[Vb](c[d]),
                f = Mg(zb(e));
              ((b == h && f == p) || b == p) && mc(e);
            }
          ...
          if (m[I](f) != p && ((g = m[f]), (j = g.cL))) {
            ...
            if (u) {
              if (aa[M[x.id]]) {
                g = x;
                for (u = s = 0; g && g.id != J; )
                  ((s += n(g, Vi, 0)), (u += n(g, Yk, 0)), (g = g[dc]));
                W(x, Vi, s, Yk, u);
              }
              S[Fb](y);
              ha[j].kc
                ? Fa(y[H], y[H][Tc] + 100)
                : (q[z](y), y[H][Tc] > t && (t = y[H][Tc]));
            } else l[z]([g, j]);
            if (ha[j].Ub == p) {
              fa == h && Og(Yb[j]);
              rk(y, h);
      ...
      function jh(a, b, c, d) {
        ...
        function f(a) {
          ...
          if (a[La] == Zn) {
            ...
            a || (a = v[Qb]);
            for (
              e = w.elementFromPoint(a[Rb], a[Sb]);
              e != k && e != this && e.nodeName != yh;
            )
              e = e[dc];
            if (e == this) return;
            ze = [];
        ...
        if (a == dm || a == $n)
          a =
            11 <= F.$ && (ja.pointerEnabled || v.PointerEvent)
              ? Jo
              : 11 <= F.$ && ja.msPointerEnabled
                ? yi
                : $n;
        Ya(a, f, b, h);
        a == dm
      ...
      function Za(a, b, c, d) {
        jh(a, b, c, d);
        a == Zn ? jh(Yn, b, lq(), d) : a == Yn && jh(Zn, b, lq(), d);
      }
      function Qc(a, b, c) {
        c = {
          Aa: k,
      ...
      function tq(a) {
        ...
        var e = va(),
          ...
          s = 0;
        q != k &&
          (fb(u, m, 0, 2, im, f, -1 * j, 0),
          fb(u, m, 0, 2, im, q.o, 0, j),
          u[z](d(0, q.cI)),
          (s += 2));
        var x = s;
        u[z](
        ...
        l != k &&
          (fb(u, m, s, 2, Nm, f, 0, j),
          (f = -1 * l.size),
          fb(u, m, s, 2, Nm, l.o, f, f + j),
          (s += 2),
          u[z](d(s, l.cI)));
        we(n, u, { i: n, n: n, f: 30, d: s, a: u, b: [], fc: b }).na = x;
        return {
          b: n,
          c: g,
          A: 0 == g ? 0 : 1,
      ...
      function wk(a, b) {
        for (
          var c = { Ta: 1, gc: h, ka: Lm }, d = b.a, e = h, f = 0;
          f < d[X];
          f++
        ) {
          var g = d[f],
          ...
          10 == j && g.b != k
            ? (c.ga == k && (c.ga = []),
              c.ga[z]({ b: g.b, c: g.c, A: g.A, y: g.y, K: 100 / g.K }))
            : 11 == j
              ? (c.za = a)
              : 16 == j && (c.Za == k && (c.Za = []), c.Za[z](g));
        }
        e == p && Qc(a, c, ia(a, d));
      }
      function vk(a) {
        return function (b) {
          ...
          a.ma = b[La] == Jp;
          if (a.ma)
            (0 < b[gc][X] && a[xc].ka == zp && c == h && Gf(b[gc][0]),
              (a.Ya = b[gc][X]));
          else {
            ...
            a.ma
              ...
              : v.self != v.top &&
                Ya(
                  Yn,
                  function (a) {
                    (a.relatedTarget === w.documentElement ||
                      a.toElement === k) &&
                      e(a);
                  },
                  b,
                ...
                if (Kf == h) a.ta(b);
                  ...
                  if ((a.mb == p) == h) {
                    ...
                    if (c.ka == Lm) {
                      ...
                      c.za != k &&
                        ...
                        sb[e] != ba && ((sb[e].a = k), (sb[e].b = k), jk(k)),
                        cb[e] === ba && (cb[e] = {}),
                        (cb[e].a = Pm),
                        (cb[e].b = Pm),
                        fa == h && mc(c.za));
                  ...
                  if (c.ka == Lm) {
                    ...
                    var s = (x = 0),
                      ...
                      T = 1;
                    if (a.Ma != k)
                      for (var D = me(M[a.Ma.id]); D != k && D != J; )
                        ((e = ka(D)),
                          (x += n(e, Vi, 0)),
                          (s += n(e, Yk, 0)),
                          (C *= n(e, Tl, 1)),
                    ...
                    if (c.ga != k) {
                      for (
                        var N = c.ga, N = [], O = 5 <= qb(y.end, y[zc]), e = 0;
                        e < c.ga[X];
                        e++
                      ) {
                        l = c.ga[e];
                        if (16 == l.p && a.qb == p)
                          if (O == p) continue;
                            ...
                            ((q = l.b),
                            !(0 == l.c && (a.Aa == On || a.Aa == Yo)) &&
                              !(1 == l.c && (a.Aa == Pp || a.Aa == Km)))
                          ) {
                            t = la(q);
                            t = t.pa.fc;
                            t != k && t();
                    ...
                    c.ka == vp
                      ? 1 < a.Ya
                        ...
                        : (b[gb] && a.Aa == c[Dc] && b[gb](),
                          ...
                          (c = a.Aa === c[Dc] || 100 > u),
                          (D || c == p || Ae == h) && a.ta(b))
                      : c.ka == zp && 5 < qb(y[zc], y.end) && a.ta(b);
                  xk(a, d);
                }
            };
                        ...
                        if (q) {
                          ...
                          if (s == h)
                            if (
                              ...
                              (s =
                                0 == u.c
                                  ? r.abs(e[Ga].x - e.end.x) / d
                                  : r.abs(e[Ga].y - e.end.y) / d),
                              (s *= 2),
                              20 < s)
                            )
                              ((A = h),
      ...
      function Mf(a, b) {
        b[xc].gc == h &&
          ((a.hypeGesturePhase = b.Ka),
          (a.hypeGestureXPosition = b.Sa[0].end.x),
          (a.hypeGestureYPosition = b.Sa[0].end.y),
          b.Lb(a));
      }
      function Be(a, b, c) {
        var d = Jb(c);
        d != k && (c = d);
        c[Rc] ? c[Rc](a, b, p) : c[Na] && c[Na](so + a, b);
      }
      function Ya(a, b, c, d) {
        var e = Jb(c);
        e != k && (c = e);
      ...
      function Hf(a) {
        ...
        if (a.pageX || a.pageY) ((b.x = a.pageX), (b.y = a.pageY));
          ...
          ((b.x = a[Rb] + w[yb].scrollLeft + w.documentElement.scrollLeft),
            (b.y = a[Sb] + w[yb].scrollTop + w.documentElement.scrollTop));
        return b;
      }
      function zk(a) {
        var b;
      ...
      function Dk(a) {
        ...
        if (a != k) {
          for (
            var b = 1 < v.devicePixelRatio, c = p, d = k, e = 0;
            e < a[X];
            e++
          ) {
            var f = a[e],
      ...
      function Fk() {
        0 >= Zb[X] || ((nh = p), Gk(Zb[0], h));
      }
      function Gk(a, b) {
        var c = Oa[a].p;
        if (1 == c)
          if (((c = Oa[a].g), c != k && Dk(c) != a)) mh(a, b);
          else {
            var c = new Image(),
              d = function () {
                mh(a, b);
          ...
          2 == c &&
            ((c = function () {
              for (var c = Hd[Oa[a].g], e = 0; e < c[X]; e++) {
                var d = c[e];
                Oa[d].p != k && mh(d, b);
              }
            }),
            (d = Tg(Oa[a].g)),
            (F.Na != k && 536.26 > F.xa) || 9 > F.$
              ? v[fc](c, 1)
              : d.load(c, c));
      }
      function Ek() {
      ...
      function Fd(a) {
        ...
        for (var c = [], d, e = a[X], f = 0; f < e; f++)
          ((d = a[f]), b.test(d[vc]) && c[z](d));
        return c;
      }
        ...
        if (!(Oc(a) == k || Ef == h)) {
          ...
          var e = function () {
              ...
              var f = Oc(a),
                ...
                j = va();
              if (j != k) {
                for (var m = j[hb](Vp), l = 0; l < m[X]; l++)
                  m[l][kc] && m[l][kc]();
                j = j[hb](Qm);
                for (l = 0; l < j[X]; l++)
                  0 == j[l].id[$b](Rm) && za(j[l][yc], Z);
              }
              l = Pb[nb](0);
              ...
              var f = A[n].T,
                u;
              for (u in f)
                f[I](u) != p && ((g = A[U].T[u]), g.s == ba && we(u, g.a, g));
              u = { C: Kn, D: Mn, E: Ln };
              for (var B in u)
                u[I](B) == p ||
                  A[n][B] == k ||
                  ...
                  (g = u[B]),
                  (Jd[g] = f),
                  w[ab] ? w[ab](g, f, p) : w[Tb] && w[Tb](so + g, f));
              B = A[n].L;
              for (l = 0; l < B[X]; l++)
                ((u = B[l].B), (f = ia(va(), B[l].a)), uk(u, f, k));
              ...
              for (var E in B)
                if (B[I](E) != p && (u = A[n][E])) {
                  ...
                  f == p &&
                    ((u = ia(va(), u)),
                    Qc(q, { Ta: 1, direction: B[E], ib: 30, ka: vp }, u));
                }
              (E = A[n].K) && wk(w, E);
              E = va();
              if (2 == b) {
                ...
                if (e != k)
                  ...
                  } else if (e[H][G] != E[H][G] || e[H][L] != E[H][L])
                    ((P = M[e.id]), fb(Q, Nm, K / 2, K / 2, Yk, P, 1, 0));
                W(E, Nm, 0);
                oh(Xh, K, Q, e, E);
                qa(E[H], yl);
              } else if (3 == b && F.eb == h) {
                ...
                e != k &&
                  (u(s, Vi, j, j, Nm, K, q, g),
                  u(s, ml, j, j, Nm, K, -300, -600),
                  u(s, mj, j, j, Nm, K, -20, -50),
                  (Q != m || P != t) && u(s, Nm, j, j, im, K, 1, 0));
                u(s, Vi, j, j, Nm, R, l, 0);
          ...
          if (Hk == h && g != k) {
            ...
            for (var s in Jd)
              Jd[I](s) != p &&
                (w[Rc] ? w[Rc](s, Jd[s], p) : w[Na] && w[Na](so + s, Jd[s]));
            Jd = {};
            for (m = 0; m < Nf[X]; m++)
              ((s = Nf[m]), Be(s.eventType, s.handler, s[Bc]));
            Nf = [];
          }
          Hk = h;
          f == p && e();
      ...
      function vq() {
        for (var a in rh) rh[I](a) != p && (pd[a] = { q: rh[a] });
        for (var b in pd)
          if (pd[I](b) != p)
      ...
      function rf(a, b, c, d, e) {
        ...
        for (var g = 0; g < a[X]; g++) {
          ...
          j.Ia.y == j.Ha.y
            ? (l = 2)
            : ((l = qb(j.sa, j.Ia)), (l = r[Cb](r.max(r.min(l / 2, d), c))));
          for (var q = j.sa, n = 0; n < l; n++) {
            var u = fk(j, n / (l - 1)),
              s = {};
            s.location = u;
            b && ((q = qb(u, q)), (m += q), xa(s, q));
            j.ea[z](s);
            q = u;
          }
          f += m;
          ...
          c =
            b.x == a.x
              ? b.y >= a.y
                ? 90
                : -90
              : (180 * r.atan((b.y - a.y) / (b.x - a.x))) / r.PI;
        b.x < a.x && (c += 180);
        return c;
      }
      function Kd(a, b, c) {
      ...
      function Lk(a, b, c) {
        ...
        ua(e, Yf);
        if (b.bR != k || b.aY != k)
          ((e[Se] = c), (e.MozPerspective = c), (e.perspective = c));
        e.pointerEvents = no;
        e[Io] = no;
        d[Fb](a);
        return d;
      ...
      function Hg(a) {
        ...
        a == k &&
          ((a = w[Vb](b)),
          (a = { width: a[Hb], height: a.offsetHeight }),
          (Kc[b] = a));
        return a;
      }
      function jf(a) {
        var b = 0,
          c = 0;
        a == k
          ? ((b = w[Vb](Yb[a])), (a = Wa(b)), (b = A[a].Y), (c = A[a].Z))
          : ((b = ob(a)), (c = pb(a)));
        return { width: b, height: c };
      }
      function Yg(a) {
        return (F.xa != k || 3.5 <= F.Xa || 10 <= F.$) && n(a, $h) == Vf;
      }
      function Kg() {
        lf = p;
        $g = h;
      ...
      function Bb(a) {
        if (zf != k && a != h) return zf;
        var b = new Date().getTime();
        a == h && (zf = b);
        return b;
      }
      function uh() {
        for (var a = Z, b = ca.xb + Hh, c = 0; 20 > c; c++)
          var d = r[Ec](r.random() * b[X]), a = a + b.substring(d, d + 1);
        return a;
      }
      function qe(a) {
      ...
      function Bk(a) {
        ...
        ra(b, function () {
          b.Mb();
          var a = v.HYPE_gac_778;
          a == k &&
            ((a = new (v.AudioContext || v.webkitAudioContext)()),
            (v.HYPE_gac_778 = a));
          a.resume != k && a.resume();
        ...
        b.Mb = function () {
          try {
            b[Ac] != k &&
              (b[Ac].noteOff != k ? b[Ac].noteOff(0) : b[Ac].stop(0));
          } catch (a) {}
        };
        b.tc = function () {
      ...
      var Ae = p,
        ...
        Kf = p,
        ye = [];
      typeof String.prototype.trim !== gn &&
        (String.prototype.trim = function () {
          return this[uc](/^\s+|\s+$/g, Z);
        });
      ca.z_o = function () {
        0 == Ok && (Ok = uh());
        ef != k && ef(h, S);
        ...
        for (a = 0; a < sj[X]; a++)
          ((b = sj[a]),
            ...
            9 > F.$ &&
              ((b = b.match(/('|")(http.*?css.*?)('|")/)),
              b != k && 2 <= b[X] && w.createStyleSheet(b[2])));
        v[fc](rc, 120);
        v[fc](rc, 1200);
        a = w[Sc](Jm);
        a.id = Lh;
        ...
        for (b = 0; b < A[X]; b++) {
          ...
          for (j in e)
            if (e[I](j) != p && ((f = e[j]), (g = f.cL) && ha[g] == k)) {
              ...
              m = Mk(c, f, j, [Ih, vi]);
              if (F.eb == h && (F.$ == k || 11 <= F.$))
                ((n = Lk(m, f, c.p)), n[Y](Nh, c._), a[Fb](n));
              else a[Fb](m);
          ...
          for (u = 0; u < l[X]; u++)
            if (
              ...
              F.eb == h && (F.$ == k || 11 <= F.$)
                ? ((n = Lk(m, f, c.p)), g ? ha[g][Bc][Fb](n) : d[Fb](n))
                : g
                  ? ha[g][Bc][Fb](m)
                  : d[Fb](m);
            }
        ...
        if (fa == h) {
          var C, B;
          "undefined" !== typeof w.hidden
            ? ((C = pn), (B = $p))
            : "undefined" !== typeof w.wc
              ? ((C = bo), (B = co))
              : "undefined" !== typeof w.xc
                ? ((C = eo), (B = fo))
                : "undefined" !== typeof w.Bc && ((C = bq), (B = cq));
        ...
        for (var D in Oa)
          Oa[I](D) != p &&
            ((x = Oa[D].g),
            x != k &&
              ((y = Hd[x]), y == k && ((y = []), (Hd[x] = y)), y[z](D)));
        for (var E in Oa)
          Oa[I](E) != p && Oa[E].p != k && -1 == Ia(Zb, E) && Zb[z](E);
        D = Zb[nb](0);
        if (0 == D[X]) Ek();
        else if (9 > F.$) Fk();
      ...
      if (ja) {
        if (ja.userAgentData != k)
          for (var wh = ja.userAgentData.brands, Qf = 0; Qf < wh[X]; Qf++)
            if (-1 != wh[Qf].brand[$b](Ah)) {
              Q.Wa = da(wh[Qf].version);
              Q.xa = 537.36;
              break;
            }
        Q.Wa == k &&
          ...
          (Q.Zb =
            da(Q.xa && $a(/Safari\/(\d+\.\d+)/) && $a(/Version\/(\d+\.\d+)/)) ||
            k),
          (Q.opera =
            da($a(/Opera\/(\d+\.\d+)/) && $a(/Version\/(\d+\.\d+)/)) ||
            $a(/Opera\/(\d+\.\d+)/) ||
            da(Q.xa && $a(/OPR\/(\d+\.\d+)/)) ||
            k),
          (Q.dc = -1 < ja[Ka][ib](Bg) || k),
        ...
        for (var xh in Q) (Q[xh] === k || isNaN(Q[xh])) && delete Q[xh];
        Q[bc] && Q.$ && delete Q.$;
        Q.Gb = p;
        try {
      ...
      var P = {
          ...
          X: function (a, b) {
            a[H].letterSpacing = K(b, 3);
          },
          E: function (a, b) {
            a[H].wordSpacing = K(b, 3);
          },
          Y: function (a, b) {
            a[H].lineHeight = K(b, 3);
          },
          aX: Wj,
          aW: Wj,
          f: oc,
          ...
          e: function (a, b) {
            if (9 > F.$ || (F.$ != k && F.Yb)) {
              if (1 == ea(b)) (V(a, Uh, Z), V(a, Th, Z));
                ...
                var c = Ag + r[Gb](100 * b) + ae;
                V(a, Uh, ca.pb + Ve + c);
                V(a, Th, c[Fc]());
                a[H].backgroundColor == Z &&
                  a[H].backgroundImage == Z &&
                  w[Vb](En + a.id) == k &&
                  oa(a[H], Rp + xf(Pc(Ge)) + Rd);
              }
              se(a);
            }
            a[H].opacity = b;
          ...
          bE: function (a, b) {
            ...
            if (d != k) {
              ...
              if (c != k && 9 > F.$) {
                d = a[jc][Sc](Jm);
                Aa(d, Ih);
                for (e = 0; e < a.attributes[X]; e++)
                  ((g = a.attributes.item(e)), d[Y](g.name, g.value));
                if (a.hasChildNodes)
                ...
                e = Zm;
                g = d[kb](hm);
                if (g != k && (g == hm || g == Vf || g == Ki || g == Mp))
                  e = Mp;
                g = Zm;
                f = d[kb](Qn);
                if (f != k && (f == Qn || f == Vf || f == Ki || f == Mp))
                  g = Mp;
                f = Xf;
                j = d[kb](go);
                if (j != k && (j == go || j == Vf || j == Ki || j == Mp))
                  f = cf;
                za(
                  d,
                  jg +
          ...
          cZ: function (a, b) {
            if (Jb(a) != k) ud(a);
              ...
              (3.6 > F.Xa || 9 > F.$) &&
              (a[H].backgroundRepeat == k ||
                a[H].backgroundRepeat == Z ||
                a[H].backgroundRepeat == mo)
            ) {
              var c = En + a.id,
                d = w[Vb](c);
              d != k
              ...
              V(d, Rh, d.src);
              9 > F.$ &&
                b.substr(b[X] - 4)[Fc]() == af &&
                ((d.src = Pc(Ge)),
                (c = xf(b)[uc](/\%/gi, Md)),
                V(d, Sh, ca.pb + We + c + Rd),
                V(d, Qh, ca.pb + $e),
                se(d));
              Lc(a);
            } else oa(a[H], Rp + xf(b) + Rd);
          },
          q: function (a, b) {
          ...
          p: function (a, b) {
            if (Jb(a) != k) ud(a);
              ...
              if (b != k && b != mo) {
                var c = w[Vb](En + a.id);
                c != k && (oa(a[H], Rp + xf(n(c, Rh)) + Rd), c[dc][Cc](c));
              }
          ...
          dX: function (a, b) {
            a[H][Cn] = b;
            b == Go &&
              (F.Xa != k ? (a[H][Cn] = Je) : 10 > F.Zb && (a[H][Cn] = Re),
              (a[H][Le] = jo));
          },
          aF: function (a, b) {
            a[H].cssText += Uc + b;
                ...
                if (a[H][Io] == no) {
                  ...
                  w.createEvent
                    ? (b[gb](),
                      ...
                      f.dispatchEvent(c))
                    : ((c = w.createEventObject()),
                      (c.clientX = b[Rb]),
                      (c.clientY = b[Sb]),
                      f.fireEvent(so + b[La], c),
                      (event.cancelBubble = h));
                }
              };
              Ya(yi, c, a, h);
              Ya($n, c, a, h);
        ...
        Kj = function b(c) {
          ...
          d.ic = function (b) {
            ...
            if (j == h) ((j = c[0]), (b = sa(j, 0)), d[z](Kb(b, b, b)));
              ...
              for (var m = c[X], l = 0; l < m - (b[Qa] == h ? 1 : 0); l++)
                ((j = c[l]),
                  0 == l && d[z](Kb(sa(j, 0), sa(j, 2), Pj(b))),
                  l + 1 == m && b[Qa] == p
                    ? d[z](Kb(sa(j, 6), Oj(b, l), sa(j, 4)))
                    : d[z](Kb(sa(j, 6), sa(c[l + 1], 2), sa(j, 4))));
            return d;
          };
          d.Nb = function (b) {
            for (
              var c = d.ba[nb](0), g = -1, j = -1, m = 0, l = 0, n = 0;
              n < c[X];
              n++
            ) {
              var t = c[n];
            ...
            if (0 < l + m && 1 < c[X] && -1 != g && -1 != j)
              if (((g = c[g]), (t = c[j]), b[Qa] == h)) {
                j = Nj(t, g, l + m);
                for (n = 0; n < j[X]; n++)
                  c[(d.ba[X] - m - 1 + n) % d.ba[X]] = j[n];
              } else {
                for (n = 0; n < l; n++) c[n] = Kb(g.aa, g.aa, g.aa);
                for (n = 0; n < m; n++)
                  c[d.ba[X] - m + n] = Kb(t.aa, t.aa, t.aa);
              }
            l = { closed: b[Qa] };
            g = [];
            if (1 == c[X])
              ((t = c[0]), (m = Rg(t.aa, t.aa, t.aa, t.aa)), g[z](m));
            else if (1 < c[X]) {
              for (n = 1; n < c[X]; n++)
                ((m = c[n - 1]),
                  (t = c[n]),
                  (m = Rg(m.aa, m.ha, t.la, t.aa)),
                  g[z](m));
              b[Qa] == h &&
                ((m = c[c[X] - 1]),
                (t = c[0]),
          ...
          d.bounds = function () {
            ...
            for (
              var b = ma[jb], c = -ma[jb], g = ma[jb], j = -ma[jb], m = 0;
              m < d.ba[X];
              m++
            ) {
              var l = d.ba[m].aa;
    ...
    v.HYPE == k && ((v.HYPE = v.HYPE_778F), (v.HYPE.documents = {}));
    var R = [];
    v.HYPE_dtl_778F != k && (R = v.HYPE_dtl_778F[nb](0));
    v.HYPE_dtl_778F = [];
